...
export function VenueSearch({ onSearch, onFilterCategory, onFilterLocation }: VenueSearchProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 mb-6">
      ...
      <FilterSelect options={locationOptions} onFilter={onFilterLocation} placeholder={t('filterLocation')} />
    </div>
  )
}
